...
mixin _$SubjectDetailsState {
  ...
  List<UserModel> get attendees => throw _privateConstructorUsedError;
...
class _$_SubjectDetailsState implements _SubjectDetailsState {
  const _$_SubjectDetailsState(
      ...
      required final List<UserModel> attendees,
  ...
  final List<UserModel> _attendees;
  @override
  List<UserModel> get attendees {
  ...
  @override
  String toString() {
    return 'SubjectDetailsState(subject: $subject, attendees: $attendees, attendances: $attendances)';
  }
...
abstract class _SubjectDetailsState implements SubjectDetailsState {
  const factory _SubjectDetailsState(
      ...
      required final List<UserModel> attendees,
      required final List<Attendance> attendances}) = _$_SubjectDetailsState;
